...
#     summary(mod_lr_11)
 ...
 mod_lr_13 <- lm(Umsatz ~ as.factor(Wochentag) + Temperatur^3 + as.factor(Warengruppe) + as.factor(Wochentag) + as.factor(FerienSH) + Temperatur + as.factor(KielerWoche) + Bewoelkung + Windgeschwindigkeit +  as.factor(Monat) + as.factor(Monat) * Temperatur, df)
     summary(mod_lr_13)
