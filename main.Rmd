...
mod_lr_12 <- lm(Umsatz ~ Datum * Temperatur + as.factor(Warengruppe) + as.factor(Wochentag) + as.factor(FerienSH) + Temperatur + as.factor(KielerWoche) + Bewoelkung + Windgeschwindigkeit + as.factor(Wettercode) + as.factor(Monat) + as.factor(Monat) * Temperatur, clean_df)
    summary(mod_lr_12)
